...
export function BottomBanner() {
  ...
  useEffect(() => {
    async function loadAds() {
      ...
      const result = await getActiveAds("bottom_banner", pathname, userGroup);
  ...
  return (
    <div className="relative w-full bg-zinc-900 border-t border-zinc-800">
      <div className="max-w-6xl mx-auto px-2 sm:px-4 py-2 sm:py-3 flex items-center justify-between gap-2 sm:gap-4">
        {ads.length > 1 && (
          <button
            onClick={handleNext}
        ...
        <button
          onClick={handleClick}
          className="flex-1 flex items-center justify-center min-h-[50px] sm:min-h-0"
        >
          <img
